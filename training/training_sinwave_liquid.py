...
if not os.path.isdir('sinwave_liquid_' + str(num_nodes) + '_nodes'):
    os.mkdir('sinwave_liquid_' + str(num_nodes) + '_nodes')
with open('sinwave_liquid_' + str(num_nodes) + '_nodes/weight_history.json', 'w') as f:
