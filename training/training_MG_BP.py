...
if not os.path.isdir('MacheyGlass_' + str(num_nodes) + '_nodes'):
    os.mkdir('MacheyGlass_' + str(num_nodes) + '_nodes')
with open('MacheyGlass_' + str(num_nodes) + '_nodes/weight_history.json', 'w') as f:
