# RNN on sine wave, using hebbian learning to update weight matrix (Can't reproduce)
...
if not os.path.isdir('sinwave_hebb_' + str(num_nodes) + '_nodes'):
    os.mkdir('sinwave_hebb_' + str(num_nodes) + '_nodes')
with open('sinwave_hebb_' + str(num_nodes) + '_nodes/weight_history.json', 'w') as f:
