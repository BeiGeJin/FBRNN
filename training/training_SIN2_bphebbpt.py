...
if not os.path.isdir('../weights/SIN2_bphebbpt_' + str(num_nodes) + '_nodes'):
    os.mkdir('../weights/SIN2_bphebbpt_' + str(num_nodes) + '_nodes')
with open('../weights/SIN2_bphebbpt_' + str(num_nodes) + '_nodes/weight_history.json', 'w') as f:
