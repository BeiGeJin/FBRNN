...
if __name__ == "__main__":
    ...
    for epoch in tqdm(range(epochs), position=0, leave=True):
        ...
        for x, y in zip(shuffled_xs, shuffled_ys):
            ...
            # hebbian learning
            if epoch > 200 and last_epoch_loss < 0.001 and has_hebbian == 0:
                print("hebbian start!!!")
                has_hebbian = 1
            if has_hebbian == 1 and loss < 0.001:
            ...
            if epoch > 300 and last_epoch_loss < 0.001 and has_boundary == 0:
                # create boundaries
            ...
            if has_boundary == 1 and last_epoch_loss < 0.001:
