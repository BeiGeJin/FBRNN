...
\subsection*{Model}
\begin{itemize}
    \item Structure: 1 input layer (1D input), 1 recurrently-connected hidden layer (128 nodes) where 50\% is excitatory neurons (following Dale's law), 1 output layer (1D output).
