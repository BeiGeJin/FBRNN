...
To my understanding, we want our network to do the following:
...
To find out why there was this phase-shifting problem, I did the test of step 3 decribed above (i.e., using the target as pretended output to perform the Hebbian learning). I found that the network naturally converge to a point where the actual output is the phase-shifted sine wave.
