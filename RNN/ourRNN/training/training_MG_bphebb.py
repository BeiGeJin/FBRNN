...
if not os.path.isdir('MacheyGlass_hebb_' + str(num_nodes) + '_nodes'):
    os.mkdir('MacheyGlass_hebb_' + str(num_nodes) + '_nodes')
with open('MacheyGlass_hebb_' + str(num_nodes) + '_nodes/weight_history.json', 'w') as f:
