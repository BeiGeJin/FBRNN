...
if not os.path.isdir('SIN2_wtexppt_' + str(num_nodes) + '_nodes'):
    os.mkdir('SIN2_wtexppt_' + str(num_nodes) + '_nodes')
with open('SIN2_wtexppt_' + str(num_nodes) + '_nodes/weight_history.json', 'w') as f:
